...
**v24.0.9.11 ✅ · 150+ versions · 31 eras · 2023+ tests · 0 warnings**
...
Era 22 — PKT Testnet Integration: Wire Protocol, Sync, Explorer, PKT Node    ✅
Era 23 — Developer Experience: Devnet, Docs, E2E Tests, Hot Reload           ✅
Era 27 — PKTScan Desktop App: Tauri v2, React, Live Dashboard, Charts         ✅
Era 28 — PKTScan Desktop Advanced: Miner IPC, i18n, Wallet, Peer Scan        ✅
Era 29 — Backend Fix: Address Index, UTXO Height, Block TX Count, Broadcast  ✅
Era 30 — PKT Full Node: TX Validation, Relay, Multi-peer, Mempool, IBD       ✅
Era 31 — Public Testnet: EVM Address, Network Paths, Frontend Fixes          ✅ v24.0.9.11
```
...
**Web explorer:** [testnet.oceif.com](https://testnet.oceif.com/) · [oceif.com/blockchain-rust](https://oceif.com/blockchain-rust/)
