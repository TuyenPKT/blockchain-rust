...
**Version hiện tại: v5.3 ✅ — 97/97 tests pass, 0 errors, 0 warnings**
...
Stack đã có:
  ...
  v5.3       Maturity (src/maturity.rs):
               CoinbaseGuard: MATURITY_DEPTH=100, register/is_mature/blocks_until_mature
               TxReplayGuard: bounded FIFO, confirm/is_replay/confirm_block (skip coinbase)
               LockTimeValidator: check_locktime, all_inputs_final, is_final, SEQUENCE_FINAL

Next: v5.4 — Fee market: dynamic estimation, RBF
```
